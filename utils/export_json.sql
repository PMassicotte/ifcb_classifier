...
FROM
  read_json_auto(
    'run-output/inception_v3_2025_07_09_with_img_norm_sosik_2006/v3/inception_v3_2025_07_09_with_img_norm/img_results.json',
...
COPY (
  ...
  ORDER BY
    image_idx,
    class_idx
) TO 'results/flattened_results_sosik_2006.csv' (HEADER, DELIMITER ',');
