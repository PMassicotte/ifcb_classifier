...
FROM
  read_json_auto(
    'run-output/inception_v3_icecamp_ge2015/v3/inception_v3_smhi_tangesund_b32_flipxy/img_results.json',
...
COPY (
  ...
  ORDER BY
    image_idx,
    class_idx
) TO 'results/flattened_results_ge2015_icecamp.csv' (HEADER, DELIMITER ',');
